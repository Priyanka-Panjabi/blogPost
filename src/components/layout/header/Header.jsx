...
export const Header = () => {
  ...
  return(
    <header>
      <Box sx={{ display: 'flex' }}>
      <CssBaseline />
      <AppBar component="nav" sx={{backgroundColor: theme?'#343434': 'whitesmoke' }}>
        <Toolbar >
          <IconButton
            aria-label="open drawer"
            edge="start"
            onClick={handleDrawerToggle}
            sx={{ mr: 2, display: { sm: 'none' } , color: theme? 'white':'#000000' }}
          >
            <MenuIcon />
          </IconButton>
        ...
        <Drawer
          ...
          sx={{
            ...
            '& .MuiDrawer-paper': { boxSizing: 'border-box', width: drawerWidth, color:theme? 'white':'#000000', backgroundColor: theme?'#343434':'white', },
          }}
